    ...
    (function(util,vec2,Scene,PointDragger) {
        ...
        var Circle = function(middle, radius, lineStyle) {
            ...
            this.createDraggers = function() {
                ...
                var getP1 = function() { return [_circle.center[0],(_circle.center[1] - _circle.radius)]; };
                var setP1 = function(dragEvent) { _circle.radius = Math.abs(dragEvent.position[1] - _circle.center[1]) ;};
